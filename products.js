...
async function initial() {
  let res = await fetch(
    `https://Hanae-server.herokuapp.com/products?section=${query}`
  );
...
//     {
//       let res = await fetch(
//         `https://Hanae-server.herokuapp.com/products/lowToHigh`
//       );
...
//     {
//       let res = await fetch(
//         `https://Hanae-server.herokuapp.com/products/highToLow`
//       );
